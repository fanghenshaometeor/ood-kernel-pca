...
- A cosine kernel $k_{\rm cos}(\boldsymbol{z}_1,\boldsymbol{z}_2)=\frac{\boldsymbol{z}_1^\top\boldsymbol{z}_2}{\|\boldsymbol{z}_1\|_2\cdot\|\boldsymbol{z}_2\|_2}$ and its feature mapping $\Phi(\boldsymbol{z})\triangleq\phi_{\rm cos}(\boldsymbol{z})=\frac{\boldsymbol{z}}{\left\Vert\boldsymbol{z}\right\Vert_2}$.
